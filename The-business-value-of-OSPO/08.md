...
有一点是所有受访者都达成了绝对的一致：OSPO 未来将会持续演进。特别是，OSPO 越是成熟，就越能进行战略思考，并帮助整个组织制定一种更具战略意义、更深思熟虑的开源道路。他们并不需要或不期望的是，更多地关注法律合规性，这是一个复选项，大多数受访者认为这更像是一个最低要求，而且他们的工作已经覆盖了这一点。
...
几位受访者谈到，希望 OSPO 在影响其公司未来采用的技术和项目方面发挥更大的作用。也有人希望 OSPO 能够更深入地研究依赖关系链，更好地了解他们所依赖的项目，哪怕只是两三级依赖的项目，并跟踪这些项目的健康状况（以及在必要时做出贡献）。其他人谈到了构建自动化平台来处理一些当前的手动任务，比如批准贡献项目的申请。
