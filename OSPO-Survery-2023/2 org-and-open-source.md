...
请让我们了解一下您的公司的开源情况。开源办公室（OSPO）是一个专门设立或虚拟的专家组织，其成员为公司里面的开源工作提供支持、扶持、共享、解释和促进等服务。
...
* No
9. 您的公司有开源计划或开源相关的专项行动否 ？ （单选）
* 有，是一个正式的计划，有专人的全职工作，有相关的汇报机制和岗位。
...
10. 下面哪个选项最符合您公司向上游开源项目提供贡献的正式策略（单选）
* 不允许提供贡献
* 若开源协议要求，就提供贡献
* 公开鼓励提供贡献
* 不清楚，不确定
...
11. 您公司开源计划或相关专项行动的主要任务是（请选出全部符合情况的选项）
* 培育或保持公司内部的开源人才
* 管理公司的开源基础设施
* 为开源技术和开源项目提供建议
* 与开源组织协作
...
* 10 or more
* Don't know or not sure
12. 您公司正式或虚拟的开源计划、专项行动里面，有多少员工参加（请选择一个选项）
* 0 （没有专职员工）
* 1
* 2-4
* 5-9
...
13. 您公司的开源计划或专项行动，是在公司的哪个业务部门 ？若这些是正式工作，组织者需要向下面的哪个部门汇报（单选）
* 法律部门
* 软件工程和开发
* IT和企业运算
* 公司CTO或CIO办公室
...
* No
* Don't know or not sure
14. 您公司的开源计划是否有内部开源的团队、战略或实施原则，去推动公司内部的开源文化（单选）
...
19. 您能分享一些OSPO创建或管理的反模式实践（表现欠佳的实践）吗？ 【开放问题】
...
* Other (please specify)
20. 您公司从开源计划或开源专项行动中获得的最有收益的领域有哪些（多选）
* 开发人员的招聘和保持规模
* 更快的研发周期，更迅速的新产品发布
* 文化变革，改进的跨部门协作
* 对开源和商业软件依赖的更好认知
...
21. 您公司的开源计划或开源专项行动，如何量化方式评估是否成功（多选）
* 更少的许可违规
* 更快的合规审核流程
* 对上游项目的代码贡献量
* 开源项目的启动数量
...
* Don't know or not sure
22. 您公司的开源计划或开源专项行动的三个最大挑战是什么？ （最多选三个）
* 发现和招聘开源开发人员
* 对开源项目的影响力
* 管理层的认知和支持
* 预算不足，开源计划的开销
...
* Extremely critical
* Don't know or not sure
23. 您公司的开源计划或开源专项行动，其在企业内的关键程度是（单选）
* 根本不重要
* 不太重要
* 有点重要
* 非常重要
...
25. 请给出您公司的开源计划或开源专项行动起到正面作用的一到两个具体变革案例
...
* Other (please specify)
26. 请给出您公司的开源计划或开源专项行动，在公司外部起到正面的社会影响的领域（多选）
* 因为开源带来的更公平的招聘机会
* 对数字公共服务、数字公益更为公平的访问
* 更好的互操作性
* 让非开发人员更好了解开源
