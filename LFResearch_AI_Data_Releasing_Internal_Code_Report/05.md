...
Develop a trademark strategy and policy制定商标战略和政策
---------------------------------------------------------
...
Register external accounts注册外部账号
--------------------------------------
...
Develop a certification/compliance strategy制定一个认证/合规战略
----------------------------------------------------------------
...
Recruit business partners招募商业伙伴
-------------------------------------
...
Establish project governance建立项目管理制度
--------------------------------------------
...
Set up project infrastructure建立项目基础设施
---------------------------------------------
...
Apply recommended practices for your GitHub repo推荐你的 GitHub 仓库实行的措施
------------------------------------------------------------------------------
