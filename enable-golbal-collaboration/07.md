...
Anthony 是 DEEP 中心的创始人和总裁，也是国际公认的商业和社会中的数字革命、创新和创造力方面的权威。他与Don Tapscott 合著了开创性的畅销书《维基经济学》及其后续版本《宏观维基经济学： 互联星球的新解决方案》。
...
在其他任命中，Anthony 担任[**区块链研究所**](https://www.blockchainresearchinstitute.org/)的研究主任，[**Markle 基金会**](https://www.markle.org/)的美国经济未来倡议的专家顾问，以及布鲁塞尔的[**里斯本理事会**](https://www.lisboncouncil.net/)的高级研究员。Anthony 最近成为了国家研究委员会[**科学促进环保局未来委员会**](https://www.nap.edu/catalog/13510/science-for-environmental-protection-the-road-ahead)的成员，多伦多大学[**蒙克全球事务学院**](https://munkschool.utoronto.ca/)的访问学者，以及巴西自由教育项目的首席顾问。他在技术和创新方面的工作已在《哈佛商业评论》、《赫芬顿邮报》和《环球邮报》等出版物上刊登。
...
Futurewei 与世界各地具有前瞻性的公司保持持续、深入的合作。
...
我们追求研究和开发（R&D）的开放性，接受开放的创新模式，努力与技术社区分享想法和知识，创造新的商业机会。

-   Our vision is *Shaping the Future Toward a Fully Connected,
    Intelligent World.*

- 我们的愿景是*塑造一个完全连接的智能世界的未来。*
...
- 我们的使命*是通过开源、标准化和生态系统内的协作来开发创新，使智能和数字社会受益。*
...
在过去的二十年里，我们的专家积极投身于标准项目。通过这项工作，我们参与开发下一代无线技术和网络，并通过 ICT 系统的开放应用平台建立开放的生态系统。
...
Linux 基金会研究部成立于 2021 年，探索不断增长的开源合作规模，洞察新兴技术趋势、最佳实践和开源项目的全球影响。通过利用项目数据库和网络，以及实施的大量高质的最佳实践，Linux 基金会研究部正在创建开源洞察力的首选资料库，使世界各地的组织受益。
...
本文采用[**署名-禁止演绎 4.0 开放共享许可协议**](https://creativecommons.org/licenses/by-nd/4.0/)
...
引用该作品时，请按以下方式引用： Anthony Williams, 《促成全球合作： 开源领袖如何应对分裂的挑战》，Linux 基金会，2023 年 1 月。
